...
def get_llm() -> BaseChatModel:
    ...
    try:
        ...
        if provider == "anthropic":
            ...
            # Using dict unpacking bypasses strict static type checker issues (reportCallIssue)
            # regarding missing "timeout" and "stop" parameters in Pydantic/LangChain bindings.
            anthropic_kwargs = {
                "model": settings.llm_model,
                "temperature": settings.llm_temperature,
